...
// =========================================================================
// FUNÇÕES QUE ESTÃO FALTANDO — ADICIONE ISSO NO FINAL DO d3d9_hook.cpp
// =========================================================================
...
extern "C" void D3D9HookInstall() {
    Logf("D3D9HookInstall: placeholder — instalando hooks D3D9");
}

extern "C" void EnsureClientHooksPublic() {
    Logf("EnsureClientHooksPublic: placeholder — resolvendo hooks de cliente");
}
extern "C" void Logf(const char* fmt, ...);
// Forward decl from ImGui's Win32 backend — handles input messages.
extern IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND, UINT, WPARAM, LPARAM);
